...
awful.keyboard.append_global_keybindings{
   ...
   awful.key{
      ...
      group       = 'launcher',
      on_press    = function () awful.spawn(apps.powermenu) end,
  },
  awful.key{
      modifiers   = {mod.super},
      key         = 'a',
      description = 'show power menu',
      group       = 'launcher',
      on_press    = function () awful.spawn(apps.mpd) end,
  },
  awful.key{
      modifiers   = {mod.super},
      key         = 'v',
      description = 'show power menu',
      group       = 'launcher',
      on_press    = function () awful.spawn(apps.volume) end,
  },
  awful.key{
      modifiers   = {mod.super},
      key         = 'x',
   ...
   awful.key{
      ...
      group       = 'launcher',
      on_press    = function() awful.spawn(apps.runmenu) end,
   },
   awful.key{
      modifiers   = {mod.super},
      key         = 'p',
...
awful.keyboard.append_global_keybindings{
   ...
   awful.key{
      modifiers   = {mod.super, mod.alt, mod.shift},
      key         = 'o',
